        ...
        if (count($research) > 0) {
            ...
            foreach ($research as $item) {
                array_push($getJSON, array(
                    ...
                    "image_1" => $path = ($item->image_1) ? url('uploads/Event/Image/' . $item->id . '/' . $item->image_1) : url('image/nia.png'),
                    ...
                    "image_2" => $path = ($item->image_2) ? url('uploads/Event/Image/' . $item->id . '/' . $item->image_2) : url('image/nia.png'),
                    "image_3" => $path = ($item->image_3) ? url('uploads/Event/Image/' . $item->id . '/' . $item->image_3) : url('image/nia.png'),
                    "image_4" => $path = ($item->image_4) ? url('uploads/Event/Image/' . $item->id . '/' . $item->image_4) : url('image/nia.png'),
                    "name" => $item->name,
                    "email" => $item->email,
                    "phone" => $item->phone,
//                    "type" => $item->type,
