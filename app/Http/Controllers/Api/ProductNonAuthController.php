...
//            ->select('itdp_company_users.*','csc_product_single.*','csc_product.nama_kategori_en')
        ...
        for ($i = 0; $i < count($dataProduk); $i++) {
            ...
            $jsonResult[$i]["image_1"] = $path = ($dataProduk[$i]->image_1) ? url('uploads/Eksportir_Product/Image/' . $dataProduk[$i]->id . '/' . $dataProduk[$i]->image_1) : url('image/nia.png');
            $jsonResult[$i]["image_2"] = $path = ($dataProduk[$i]->image_2) ? url('uploads/Eksportir_Product/Image/' . $dataProduk[$i]->id . '/' . $dataProduk[$i]->image_2) : url('image/nia.png');
            $jsonResult[$i]["image_3"] = $path = ($dataProduk[$i]->image_3) ? url('uploads/Eksportir_Product/Image/' . $dataProduk[$i]->id . '/' . $dataProduk[$i]->image_3) : url('image/nia.png');
            $jsonResult[$i]["image_4"] = $path = ($dataProduk[$i]->image_4) ? url('uploads/Eksportir_Product/Image/' . $dataProduk[$i]->id . '/' . $dataProduk[$i]->image_4) : url('image/nia.png');
...
//            ->select('id', 'id_itdp_profil_eks','prodname_en','id_csc_product','id_csc_product_level1','id_csc_product_level2')
        ...
        $dataProduka->link_image_1 = $path = ($dataProduka->image_1) ? url('uploads/Eksportir_Product/Image/' . $dataProduka->id . '/' . $dataProduka->image_1) : url('image/nia.png');
        $dataProduka->link_image_2 = $path = ($dataProduka->image_2) ? url('uploads/Eksportir_Product/Image/' . $dataProduka->id . '/' . $dataProduka->image_2) : url('image/nia.png');
        $dataProduka->link_image_3 = $path = ($dataProduka->image_3) ? url('uploads/Eksportir_Product/Image/' . $dataProduka->id . '/' . $dataProduka->image_3) : url('image/nia.png');
        $dataProduka->link_image_4 = $path = ($dataProduka->image_4) ? url('uploads/Eksportir_Product/Image/' . $dataProduka->id . '/' . $dataProduka->image_4) : url('image/nia.png');
...
//        dd($dataProduka);
    ...
    public function getImageProduk($id, $image)
    {
        ...
        if (is_file($path)) {
            ...
            return response()->download(public_path() . '/image/nia.png');
        }
    }
...
//                    "type" => $item->type,
//                    "image_1" => $path = ($item->image_1) ? url('uploads/Eksportir_Product/Image/' . $item->id . '/' . $item->image_1) : url('image/nia.png'),
...
//            $data = data;
	...
	public function getKategorina()
    {
        ...
        for ($i = 0; $i < count($dataProduk); $i++) {
            $jsonResult[$i]["id"] = $dataProduk[$i]->id;
            $jsonResult[$i]["nama_kategori_en"] = $dataProduk[$i]->nama_kategori_en;
            $jsonResult[$i]["logo"] = $path = ($dataProduk[$i]->logo) ? url('uploads/Product/Icon/' . $dataProduk[$i]->logo) : url('image/nia.png');
