...
//            ->limit(10)
            ...
            $path = ($coba) ? url('uploads/Research Corner/File/' . $coba) : url('image/nia2.png');
            $meta = [
                'code' => 200,
                'message' => 'Success',
                'status' => 'OK'
...
//        $dataProduka->link_image_1 = $path = ($dataProduka->image_1) ? url('uploads/buy_request/' . $dataProduka->id . '/' . $dataProduka->image_1) : url('image/nia2.png');
