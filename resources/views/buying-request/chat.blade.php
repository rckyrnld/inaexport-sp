                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            ...
                            <a onclick="kirimchat()" class="btn btn-success" id="btn-chat">
                                <font color="white"><i class="fa fa-paper-plane"></i> Send</font></a>
								<a  class="btn btn-info" data-toggle="modal" data-target="#myModal2">
								<font color="white">  <i class="fa fa-paperclip"></i></font></a>
								<a class="btn btn-warning" onclick="rfr()"><font color="white"><i class="fa fa-refresh"></i></font></a>
                        </span>
                    </div>
                </div>
				<br>
...
<div class="modal fade" id="myModal2" role="dialog">
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										...
										<form id="formId" action="{{ url('uploadpop3') }}" enctype="multipart/form-data" method="post">
											{{ csrf_field() }}
											<div class="modal-body">
												<div class="form-row">
													<div class="col-sm-3">
													...
													<div class="form-group col-sm-7">
														...
														<input type="hidden" class="form-control" name="idc" id="idc" value="<?php echo Auth::guard('eksmp')->user()->id_role;; ?>">
														<input type="hidden" class="form-control" name="idd" id="idd" value="<?php echo Auth::guard('eksmp')->user()->id; ?>">
														<input type="hidden" class="form-control" name="ide" id="ide" value="<?php echo Auth::guard('eksmp')->user()->username; ?>">
