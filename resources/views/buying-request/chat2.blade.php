...
<a href="{{url('br_pw_lc/'.$id_br)}}" class="btn btn-danger"><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-arrow-left "></i> Kembali&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></a>
</div>
<!--
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer" style="color:white!important;">
			<a href="{{url('br_deal/'.$id.'/'.$id_br.'/'.Auth::user()->id)}}" class="btn btn-warning"><font color="white">Deal</font></a>
