                    ...
                    <div id="exTab2" class="container">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link active" href="#admin" id="set_admin"
                                                    data-toggle="tab"><h6><b>Member</b></h6></a></li>
                            <li class="nav-item"><a class="nav-link" href="#rc" id="set_perwakilan" data-toggle="tab">
                                    <h6><b>Research Corner</b></h6></a></li>
                            <li class="nav-item"><a class="nav-link" href="#in" id="set_importir" data-toggle="tab"><h6>
                                        <b>Inquiry</b></h6></a></li>
                            <li class="nav-item"><a class="nav-link" href="#by" id="set_importir" data-toggle="tab"><h6>
                                        <b>Buying Request</b></h6></a></li>
                            <li class="nav-item"><a class="nav-link" href="#ev" id="set_importir" data-toggle="tab"><h6>
                                        <b>Event</b></h6></a></li>
                            <li class="nav-item"><a class="nav-link" href="#tr" id="set_importir" data-toggle="tab"><h6>
                                        <b>Training</b></h6></a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="rc">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div id="top_downloader" class="top_data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div id="top_rc" class="top_data"
                                             style="height: 300px; margin: 0 auto; width: 100%; float: left;"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="in">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div id="top_inquiry" class="top_data"
                                             style="height: 300px; width: 100%; margin: 0 auto; float: left;"></div>
                                    </div>
                                </div>
                            </div>
