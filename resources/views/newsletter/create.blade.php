              ...
              <div class="col-md-1"></div>
                 ...
                 <div class="col-md-2">
                  <div class="form-group" style="width: 100%; height: 35px">
                      <input type="checkbox" name="send_to[]" {{$all_chck}} onclick="send_to(this)" id="to_all" autocomplete="off" value="All"/>
                      <div class="btn-group" style="width: 100%; height: 100%">
                          ...
                          <label for="to_all" class="btn btn-default active border-color" style="border-color: #aeb5b7; width: 70%; height: 100%;">
                              All
                          </label>
                      </div>
                  </div>
                ...
                <div class="col-md-2">
                  <div class="form-group" style="width: 100%; height: 35px">
                      <input type="checkbox" name="send_to[]" {{$prov_chck}} onclick="send_to(this)" id="to_province" autocomplete="off" value="Province"/>
                      <div class="btn-group" style="width: 100%; height: 100%">
                          <label for="to_province" class="btn btn-default border-color" style="border-color: #aeb5b7; width: 30%; height: 100%;">
                              <span class="fa fa-check" style="font-size: 16px;"></span>
                              <span></span>
                          </label>
                          <label for="to_province" class="btn btn-default active border-color" style="border-color: #aeb5b7; width: 70%; height: 100%;">
                              Province
                          </label>
                      </div>
                  </div>
                ...
                <div class="col-md-2">
                  <div class="form-group" style="width: 100%; height: 35px">
                      <input type="checkbox" name="send_to[]" {{$cat_chck}} onclick="send_to(this)" id="to_category" autocomplete="off" value="Category"/>
                      <div class="btn-group" style="width: 100%; height: 100%">
                          <label for="to_category" class="btn btn-default border-color" style="border-color: #aeb5b7; width: 30%; height: 100%;">
                              <span class="fa fa-check" style="font-size: 16px;"></span>
                              <span></span>
                          </label>
                          <label for="to_category" class="btn btn-default active border-color" style="border-color: #aeb5b7; width: 70%; height: 100%;">
                              Category
                          </label>
                      </div>
                  </div>
