...
<div style="margin: 0% 18% 0% 18%;">
	<img src="{{url('/').'/assets/assets/images/headeremail2.jpg'}}" style="width: 100%;" alt="."><br>
	<h2 style="color: skyblue;">Information</h2><hr>
	<span id="messages">
		<?php echo $messages; ?>
	</span>
	@if($file != null)
		<center><img src="{{url('/').'/uploads/Newsletter/File/'.$file}}" style="width: 100%;" alt="."></center>
	@endif
	<br>
	...
	<img src="{{url('/').'/assets/assets/images/footeremail2.jpg'}}" style="width: 100%; margin-top: 10px;" alt="."><br>
</div>