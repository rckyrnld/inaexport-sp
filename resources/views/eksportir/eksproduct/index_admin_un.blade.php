    ...
    $(document).ready(function () {
        $('#tablebrands').DataTable({
            ...
            columns: [
                ...
                {data: 'code_en', name: 'code_en',sWidth: '30px'},
                ...
                {data: 'size_en', name: 'size_en',sWidth: '30px'},
                {data: 'raw_material_en', name: 'raw_material_en',sWidth: '30px'},
                {data: 'capacity', name: 'capacity',sWidth: '30px'},
                {data: 'price_usd', name: 'price_usd',sWidth: '20px'},
                {data: 'product_description', name: 'product_description',sWidth: '30px'},
                {data: 'status', name: 'status',sWidth: '20px'},
                {data: 'information', name: 'information',sWidth: '20px'},
                {data: 'action', name: 'action', orderable: false, searchable: false,sWidth: '20px'},
