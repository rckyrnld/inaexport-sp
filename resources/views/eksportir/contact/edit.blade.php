                        ...
                        <div class="box-body">
                            <div class="form-row">
                                <div class="form-group col-sm-6">
                                    <label>Name</label>
                                    <input type="text" value="{{$val->name}}" name="name" id="name" class="form-control">
                                </div>

                                <div class="form-group col-sm-6">
                                    <label>Position</label>
                                    <input type="text" class="form-control" value="{{$val->job_title}}" name="position" id="position" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-sm-6">
                                    <label>Phone</label>
                                    <input type="text" class="form-control" value="{{$val->phone}}" name="phone" id="phone">
