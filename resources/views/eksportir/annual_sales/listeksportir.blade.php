            ...
            <div class="box">
                ...
                <div class="box-body bg-light">
                    <div class="col-md-14">
                        ...
                        <p><h6><a href="{{url('/eksportir/annual_sales_admin/'.$id)}}" style="color: blue">Annual Sales</a></h6>
                        <p><h6><a href="{{url('/eksportir/brand_admin/'.$id)}}" style="color: blue">Brand</a></h6>
                        <p><h6><a href="{{url('/eksportir/country_patern_brand_admin/'.$id)}}" style="color: blue">Country patent brand</a></h6>
                        <p><h6><a href="{{url('/eksportir/product_capacity_admin/'.$id)}}" style="color: blue">Production capacity</a></h6>
                        <p><h6><a href="{{url('/eksportir/export_destination_admin/'.$vszDid)}}" style="color: blue">Export destination</a></h6>
                        ...
                        <p><h6><a href="{{url('/eksportir/consultan_admin/'.$id)}}" style="color: blue">Consultation</a></h6>
