                ...
                <div class="col-5">
                    <div class="breadcrumb_content">
                        <ul>
                            ...
                            @if($catActive == NULL)
                            <li><a href="{{url('/front_end/list_perusahaan')}}">@lang('frontend.liseksportir.default')</a></li>
                            @else
                            <?php echo $catActive; ?>
                            @endif
                        </ul>
                            ...
                            <div class="widget_list widget_categories">
                                ...
                                <div class="list-group list-group-flush" id="catlist">
                                    @foreach($categoryutama as $cu)
                                        ...
                                        ?>
                                        @if(count($catprod1) == 0)
                                            <a href="{{url('/front_end/list_perusahaan/category/'.$cu->id)}}" class="list-group-item">{{$cu->$nk}}</a>
                                        @else
                                            <a onclick="openCollapse('{{$cu->id}}')" href="#menus{{$cu->id}}" class="list-group-item" data-toggle="collapse" data-parent="#MainMenu"> {{$cu->$nk}} <i class="fa fa-chevron-down" aria-hidden="true" style="float: right; margin-right: -10px;" id="fontdrop{{$cu->id}}"></i></a>
                                                <div class="collapse" id="menus{{$cu->id}}">
                                                    @foreach($catprod1 as $cat1)
                                                        <a href="{{url('/front_end/list_perusahaan/category/'.$cat1->id)}}" class="list-group-item">{{$cat1->$nk}}</a>
                                                    @endforeach
                                                </div>
                                        @endif
                                    @endforeach
