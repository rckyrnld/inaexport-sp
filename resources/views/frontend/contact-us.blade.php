                    ...
                    <form action="{{url('/contact-us/send/')}}" method="POST">
                        ...
                        <div class="form-row pb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="name" autocomplete="off" required style="border-radius: 0px;" />
                                <input type="hidden" name="urlnya" value="/contact-us/">
                            </div>
                            <div class="col">
                                <label>@lang("frontend.cu-email")</label>
                                <input type="email" class="form-control" name="email" autocomplete="off" required style="border-radius: 0px;" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label>@lang("frontend.cu-subyek")</label>
                            <input type="text" class="form-control" name="subyek" autocomplete="off" required style="border-radius: 0px;" />
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary" style="border-radius: 0px;">@lang("button-name.submit")</button>
                    </form>
                </div>
