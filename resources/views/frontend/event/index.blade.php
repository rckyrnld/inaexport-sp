                ...
                <div class="col-md-6 col-lg-6" align="right"><br>
                    <form class="form-horizontal" enctype="multipart/form-data" method="GET" action="{{url('/front_end/event')}}">
                        ...
                        <div class="input-group search-event">
                            ...
                            <input type="month" id="search_date" name="tanggal" class="form-control search" placeholder="Search" autocomplete="off" @if($searchEvent == 2) value="{{$param}}" @endif>
                            <!-- <div id="boxselect2"> -->
                ...
                <div class="col-md-6 col-lg-6" align="right"><br>
                    <form class="form-horizontal" enctype="multipart/form-data" method="GET" action="{{url('/front_end/event')}}">
                        ...
                        <div class="input-group search-event">
                            ...
                            <input type="month" id="search_date2" name="tanggal" class="form-control search" placeholder="Search" autocomplete="off" @if($searchEvent2 == 2) value="{{$param2}}" @endif>
            ...
            @foreach($e_detail2 as $key2 => $ed2)
                ...
                @endif
                                                                                                                    ...
                                                                                                                    if(date('Y-m-d', strtotime($ed2->start_date)) == date('Y-m-d', strtotime($ed2->end_date))){
                                                                                                                        $tanggal = date('d F Y', strtotime($ed2->start_date));
                                                                                                                    } else if(date('Y-m', strtotime($ed2->start_date)) == date('Y-m', strtotime($ed2->end_date))){
                                                                                                                        $tanggal = date('d', strtotime($ed2->start_date)).' - '.date('d F Y', strtotime($ed2->end_date));
                                                                                                                    } else {
                                                                                                                        $tanggal = date('d F Y', strtotime($ed2->start_date)).' - '.date('d F Y', strtotime($ed2->end_date));
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    if (Auth::guard('eksmp')->user()) {
                                                                                                                        $id_ = Auth::guard('eksmp')->user()->id;
                                                                                                                        $data = DB::table('event_company_add')->where('id_itdp_profil_eks', $id_)->where('id_event_detail', $ed2->id)->first();
                                                                                                                        if ($data) {
                                                                                                                            $statt = $data->status;
                                                                                                                        }else{
                                                                                                                            $statt = null;
                ...
                <div class="col-md-6 col-lg-6" align="right"><br>
                    <form class="form-horizontal" enctype="multipart/form-data" method="GET" action="{{url('/front_end/event')}}">
                        ...
                        <div class="input-group search-event">
                            ...
                            <input type="month" id="search_date3" name="tanggal" class="form-control search" placeholder="Search" autocomplete="off" @if($searchEvent3 == 2) value="{{$param3}}" @endif>
            ...
            @foreach($e_detail3 as $key3 => $ed3)
                ...
                @endif
                                                                                                                    ...
                                                                                                                    if(date('Y-m-d', strtotime($ed3->start_date)) == date('Y-m-d', strtotime($ed3->end_date))){
                                                                                                                        $tanggal = date('d F Y', strtotime($ed3->start_date));
                                                                                                                    } else if(date('Y-m', strtotime($ed3->start_date)) == date('Y-m', strtotime($ed3->end_date))){
                                                                                                                        $tanggal = date('d', strtotime($ed3->start_date)).' - '.date('d F Y', strtotime($ed3->end_date));
                                                                                                                    } else {
                                                                                                                        $tanggal = date('d F Y', strtotime($ed3->start_date)).' - '.date('d F Y', strtotime($ed3->end_date));
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    if (Auth::guard('eksmp')->user()) {
                                                                                                                        $id_ = Auth::guard('eksmp')->user()->id;
                                                                                                                        $data = DB::table('event_company_add')->where('id_itdp_profil_eks', $id_)->where('id_event_detail', $ed3->id)->first();
                                                                                                                        if ($data) {
                                                                                                                            $statt = $data->status;
                                                                                                                        }else{
                                                                                                                            $statt = null;
