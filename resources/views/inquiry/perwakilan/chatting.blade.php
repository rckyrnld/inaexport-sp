					...
					<?php }else{ ?>
						<li class="left clearfix"><span class="chat-img pull-left">
                            ...
                            <div class="chat-body clearfix">
                                <div class="header">
									<strong class=" text-muted"><span class="pull-right primary-font"></span><b>{{getCompanyName($msg->sender)}}</b></strong>
									<small class="glyphicon glyphicon-time"> (<?php
                                        $datenya = date('d-m-Y', strtotime($msg->created_at));
                                     echo $datenya; ?>)</small>
                                </div>
...
<div class="modal fade" id="modalInvoice" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#2e899e; color:white;"> <h6>Upload Proof of Paymen</h6>
...
$(document).ready(function () {
	...
	$.get('{{URL::to("refreshchatinq2/")}}/'+a,{_token:token},function(data){
		$('#rchat').html(data)
		var con = document.getElementById("fg1");
	con.scrollTop = con.scrollHeight;
		 });
