  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
          ...
          <a id="tambah" href="{{route('master.province.create', '')}}" class="md-btn md-raised mb-2 w-sm info"><i class="fa fa-plus-circle"></i>  Add</a>&nbsp;&nbsp;<a id="tambah" href="{{route('master.province.export')}}" class="md-btn md-raised mb-2 w-sm info" target="_blank"><i class="fa fa-print"></i>  Export</a>
      	 </div>
      	  <div class="box-body">
