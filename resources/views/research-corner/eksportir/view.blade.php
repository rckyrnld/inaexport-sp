            ...
            <br>
             ...
             <div class="form-group row">
              <div class="col-md-1"></div>
                 ...
                 <div class="col-md-7">
                      <a href="{{ url('/').'/uploads/Research Corner/File/'.$data->exum}}" id="download" class="btn btn-outline-secondary" style="width: 30%"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;&nbsp;Document</a>
                 </div>
             </div>
