...
<form class="form-horizontal" method="POST" action="{{ url('simpan_profil2') }}" enctype="multipart/form-data">
           {{ csrf_field() }}
...
<div class="form-row">
		...
		<center><img width="150px" height="150px" src="{{ asset('image/fotoprofil/nofoto.jpg') }}"></center> 
		<?php }else{ ?>
		<center><img width="150px" height="150px" src="{{ asset('image/fotoprofil/'.$rhj->foto_profil) }}"></center> 
		<?php } ?>
		<br>
...
<a href="{{ url('verifyimportir') }}" class="btn btn-md btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a>
<?php } ?>
